...
export default function HomeScreen() {
  ...
  const handleTextDebounce = useCallback(debounce(handleSearch, 1100))
  
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar style={styles.StatusBar} />
      <View style={{ display: "flex", flex: 1,marginTop: StatusBar.currentHeight || 0 }}>
            ...
            <View style={styles.Location}>
              {locations.map((loc, index) => {
                ...
                let borderClass = showBorder
                  ? { borderColor: "#D1D5DB", borderBottomWidth: 2 }
                  : {};
                return (
                  <TouchableOpacity
                  ...
                  >
                    ...
                    />
                    <Text style={[styles.Textsearch, { fontSize: 20 }]}>
        ...
        <View style={{ marginBottom: 25 }}>
          ...
          >
            ...
            >
              ...
              <Text style={{ color: "white", fontWeight: "800", fontSize: 24 }}>
                17&#176;
              </Text>
            </View>
            <View
